...
export function EventCard({ description, eventName, taskImg, category }) {
    return (
        <>
            <div className='w-auto p-4 md:p-2 md:pr-6 flex max-sm:flex-col  items-start gap-6 max-sm:gap-2 rounded-[0.75rem] font-main bg-white relative text-custom-dark'>
                <img className='w-[200px] h-[200px] max-sm:w-[140px] max-sm:h-[140px] object-cover rounded-md' src={taskImg} alt="" />
