            ...
            <div className='flex justify-center items-center position-fixed relative top-0 bottom-0 w-[100vw] h-[100vh] bg-[rgba(0,0,0,0.5)] z-[999] text-custom-dark font-main'>
                <div className='flex flex-col md:w-[60vw] max-sm:w-[90vw] h-[auto] p-6 md:p-8 bg-white rounded-2xl gap-4 relative'>
                    ...
                    <div className='w-[100%] flex flex-row justify-center items-center gap-4 max-sm:flex-col'>
                        ...
                        <a className='text-[15px] text-white font-semibold border-2 border-custom-blue bg-custom-blue shadow-[0_8px_28px_0_rgba(81,97,255,0.3)] rounded-md w-[160px] text-center px-6 py-2 w-[200px] transition-all duration-300 hover:opacity-90 hover:shadow-[0_8px_28px_0_rgba(81,97,255,0.5)]' href="">Mark as Done</a>
                    </div>

                    {/* Botón de cierre */}
                    <a className='transition-all duration-300 ea absolute top-3 right-3  rounded-bl-lg rounded-tr-lg ' href="">
