  ...
  return (
    <>
      ...
      <aside
        ...
        } bg-[#5161FF] w-[350px] fixed top-0 left-0 h-full grid justify-center content-around font-main z-50 transition-all duration-500 lg:left-0`}
      >
        ...
        <div className="grid gap-8 ml-6 text-white font-bold justify-between">
          <a
            className="flex gap-4 p-3 hover:bg-white/25 hover:rounded-3xl hover:shadow-lg"
            href=""
          >
            <svg
              width="22"
