...
export function Welcome({ username }) {
    return (
        <>
            <div className='p-14 flex items-center justify-between gap-10 rounded-2xl font-main bg-custom-light-blue max-sm:flex-col-reverse border-solid border-custom-blue border-[0.5px] border-opacity-50'>
