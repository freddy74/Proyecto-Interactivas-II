    ...
    <div>
        ...
        <section className='grid grid-cols-1 sm:grid-cols-4 sm:ml-[23rem] p-4 gap-6'>
            ...
            <div className="grid col-span-3 mt-5 gap-6">
                <MainInfo username="Freddy Garro Masis" profileImg="https://unavatar.io/freddy74" location="Esparza, Puntarenas" occupation="Student" />
                <PersonalInfo firstName="Freddy" lastName="Garro" role="Student" email="freddy.garro@ucr.ac.cr" />
                <AdditionalInfo />
